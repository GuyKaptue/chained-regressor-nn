...
DEFAULT_REGRESSORS: dict[str, Any] = {
...
# Add optional regressors if available
if XGBRegressor is not None:
    DEFAULT_REGRESSORS["xgboost"] = XGBRegressor(random_state=42)
if LGBMRegressor is not None:
    DEFAULT_REGRESSORS["lightgbm"] = LGBMRegressor(random_state=42)
if CatBoostRegressor is not None:
    DEFAULT_REGRESSORS["catboost"] = CatBoostRegressor(random_state=42, verbose=0)
